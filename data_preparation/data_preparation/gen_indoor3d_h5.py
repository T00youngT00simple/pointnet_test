...
for i, data_label_filename in enumerate(data_label_files):
    ...
    data, label = indoor3d_util.room2blocks_wrapper_normalized(data_label_filename, NUM_POINT, block_size=50.0, stride=10.0,
                                                 random_sample=False, sample_num=None)
    #  Returns:
    #    block_datas: K x num_point x 9 np array of XYZxyzrgb, rgb is in [0,1]
