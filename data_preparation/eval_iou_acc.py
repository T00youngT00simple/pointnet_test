...
num_classes = 4   # 13 for Stanford Indoor data

# replace the 2018-10-09-19-32-17 by your folder name
all_pred_data_label_filelist = os.path.join(BASE_DIR, 'log_ptn/inference/2019-08-14-16-45-44/result/output_filelist.txt')
...
for i in range(num_classes):
    ...
    print(iou)
    iou_list.append(iou)
print('mIOU: ', sum(iou_list)/float(num_classes))
...
for i in range(num_classes):
    ...
    print(acc)
    acc_list.append(acc)
print('mAcc:', sum(acc_list)/float(num_classes))